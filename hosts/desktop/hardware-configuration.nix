...
# to /etc/nixos/configuration.nix instead.
{
  ...
  boot.initrd = {
    luks.devices."crypted-nixos" = {
      ...
      device = "/dev/disk/by-uuid/55f81ef3-94f4-4497-a82f-e149bbddc00c";
  ...
  fileSystems."/btr_pool" = {
    device = "/dev/disk/by-uuid/2dea7f48-bf46-4a6f-9514-395298773fcc";
    fsType = "btrfs";
  ...
  fileSystems."/boot" = {
    device = "/dev/disk/by-uuid/2DBD-21C9";
    fsType = "vfat";
  };
