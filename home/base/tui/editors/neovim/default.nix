...
###############################################################################
let
  # the path to the nvim directory
  # to make this symlink work, we need to git clone this repo to the home directory.
...
in {
  ...
  programs = {
    neovim = {
      ...
      # defaultEditor = true; # set EDITOR at the system level
      viAlias = true;
      vimAlias = true;
